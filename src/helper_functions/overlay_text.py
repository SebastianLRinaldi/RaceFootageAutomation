...
def draw_text_centered( draw:ImageDraw.ImageDraw, font, text, xy:tuple, color:tuple=(255,255,255)):
    x_frame_center, y_frame_center=xy

    x_old_bbox_center, y_old_bbox_center = get_text_center(draw, text, font, (x_frame_center, y_frame_center), color=color)
