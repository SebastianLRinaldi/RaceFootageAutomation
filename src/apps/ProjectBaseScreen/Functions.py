...
from src.widgets.NewProjectDialog.Layout import Layout as NewProjectDialogLayout
...
class Logic:
    ...
    def create_project_structure(self, date_str: str, run_id: str):
        ...
        try:
            os.makedirs(path)
            subdirs = ["Overlay1", "Overlay2", "Overlay3", "Overlay4", "Footage", "Final", "Telemetry", "Times"]
            for sub in subdirs:
