...
class Layout(UiManager):
    ...
    #             "DataGrabber", "DataViewer"
    #         ],
    #         children=[
    #             # 5 Overlay Tabs
    #             *[
    #                 self.splitter("horizontal", [
    #                     self.box("vertical", f"Overlay{i+1} Files", [
    #                         f"overlay{i+1}_list",
    #                         self.group("horizontal", [
    #                             f"add_overlay{i+1}_btn",
    #                             f"remove_overlay{i+1}_btn"
    #                         ])
    #                     ]),
    #                     self.box("vertical", f"Overlay{i+1} Preview", [
    #                         f"overlay{i+1}_preview",
    #                         f"edit_overlay{i+1}_btn"
    #                     ]),
    #                     self.box("vertical", f"Overlay{i+1} Settings", [
    #                         f"overlay{i+1}_settings_widget"
    #                     ])
    #                 ])
    #                 for i in range(5)
    #             ],
    ...
    #             # DataGrabber tab
    #             self.splitter("horizontal", [
    #                 self.box("vertical", "DataGrabber Controls", [
    #                     "datagrabber_controls_list",  # or other controls
    #                     self.group("horizontal", [
    #                         "datagrabber_action_btn1",
    #                         "datagrabber_action_btn2"
    #                     ])
    #                 ]),
    #                 self.box("vertical", "DataGrabber Preview", [
    #                     "datagrabber_preview",
    #                     "datagrabber_edit_btn"
    #                 ]),
    #                 self.box("vertical", "DataGrabber Settings", [
    #                     "datagrabber_settings_widget"
    #                 ])
    #             ]),

    #             # DataViewer tab
    #             self.splitter("horizontal", [
    #                 self.box("vertical", "DataViewer Controls", [
    #                     "dataviewer_controls_list",  # or other controls
    #                     self.group("horizontal", [
    #                         "dataviewer_action_btn1",
    #                         "dataviewer_action_btn2"
    #                     ])
    #                 ]),
    #                 self.box("vertical", "DataViewer Preview", [
    #                     "dataviewer_preview",
    #                     "dataviewer_edit_btn"
    #                 ]),
    #                 self.box("vertical", "DataViewer Settings", [
    #                     "dataviewer_settings_widget"
    #                 ])
    #             ])
    #         ]
    #     ),

    #     self.box("horizontal", "Export Project", [
    #         "export_btn"
    #     ])
    # ]
    ...
    #             widget.setLayout(QVBoxLayout())  # for settings widgets to hold controls
